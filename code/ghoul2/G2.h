...
qboolean G2_SetSurfaceOnOff(CGhoul2Info* ghlInfo, const char* surface_name, int offFlags);
...
qboolean G2_Get_Bone_Anim_Range(const CGhoul2Info* ghlInfo, const boneInfo_v& blist, const char* bone_name, int* startFrame,
	int* endFrame);
qboolean G2_Get_Bone_Anim_Range_Index(const boneInfo_v& blist, int bone_index, int* startFrame, int* endFrame);
qboolean G2_Pause_Bone_Anim(const CGhoul2Info* ghlInfo, boneInfo_v& blist, const char* bone_name, int current_time);
qboolean G2_Pause_Bone_Anim_Index(boneInfo_v& blist, int bone_index, int current_time, int numFrames);
qboolean G2_IsPaused(const CGhoul2Info* ghlInfo, const boneInfo_v& blist, const char* bone_name);
qboolean G2_Stop_Bone_Anim(const CGhoul2Info* ghlInfo, boneInfo_v& blist, const char* bone_name);
qboolean G2_Stop_Bone_Angles(const CGhoul2Info* ghlInfo, boneInfo_v& blist, const char* bone_name);
//rww - RAGDOLL_BEGIN
...
qboolean G2_Set_Bone_Angles_Matrix(const CGhoul2Info* ghlInfo, boneInfo_v& blist, const char* bone_name,
...
qboolean G2_Set_Bone_Anim_Index(boneInfo_v& blist, int index, int startFrame,
	int endFrame, int flags, float anim_speed, int current_time, float set_frame,
...
#ifdef _G2_GORE
void G2_TransformModel(CGhoul2Info_v& ghoul2, int frame_num, vec3_t scale, CMiniHeap* G2VertSpace, int use_lod,
	bool apply_gore, const SSkinGoreData* gore = nullptr);
#else
...
int G2API_InitGhoul2Model(CGhoul2Info_v& ghoul2, const char* file_name, int model_index, const qhandle_t custom_skin = NULL_HANDLE, const qhandle_t custom_shader = NULL_HANDLE, int model_flags = 0, const int lod_bias = 0);
qboolean G2API_SetLodBias(CGhoul2Info* ghlInfo, const int lod_bias);
qboolean G2API_SetSkin(CGhoul2Info* ghlInfo, qhandle_t custom_skin, const qhandle_t render_skin = 0);
...
qboolean G2API_SetBoneAnim(CGhoul2Info* ghlInfo, const char* bone_name, const int startFrame, const int endFrame, const int flags, const float anim_speed, const int acurrent_time, const float set_frame = -1, const int blend_time = -1);
...
qboolean G2API_SetBoneAngles(CGhoul2Info* ghlInfo, const char* bone_name, const vec3_t angles, const int flags, const Eorientations up, const Eorientations left, const Eorientations forward, qhandle_t* model_list, const int blend_time = 0, const int acurrent_time = 0);
qboolean G2API_SetBoneAnglesOffset(CGhoul2Info* ghlInfo, const char* bone_name, const vec3_t angles, const int flags, const Eorientations up, const Eorientations left, const Eorientations forward, qhandle_t* model_list, const int blend_time = 0, const int acurrent_time = 0, const vec3_t offset = nullptr);
...
qboolean G2API_SetBoneAnglesMatrix(CGhoul2Info* ghlInfo, const char* bone_name, const mdxaBone_t& matrix, const int flags, qhandle_t* model_list, const int blend_time = 0, const int acurrent_time = 0);
