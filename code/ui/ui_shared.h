...
constexpr auto MAX_OPEN_MENUS = 16;
...
constexpr auto SLIDER_WIDTH = 96.0;
constexpr auto SLIDER_HEIGHT = 16.0;
constexpr auto SLIDER_THUMB_WIDTH = 12.0;
constexpr auto SLIDER_THUMB_HEIGHT = 16.0;
...
using displayContextDef_t = struct
{
	...
	qboolean(*g2_SetBoneAnim)(CGhoul2Info* ghlInfo, const char* bone_name, int startFrame, int endFrame,
	...
	int (*g2_AddBolt)(CGhoul2Info* ghlInfo, const char* bone_name);
	...
	int (*g2hilev_SetAnim)(CGhoul2Info* ghlInfo, const char* bone_name, int animNum, qboolean freeze);
